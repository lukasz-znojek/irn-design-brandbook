...
Pomiar 2026-09-06: w pełnym tekście Regulaminu BUR (wersja od 5 maja 2026 r., 35 stron) **nie występuje ani razu** słowo „PSF”, „operator” ani zwrot „podmiotowy system finansowania”. Regulamin nie rozstrzyga więc tego pytania w żadną stronę - ani nie zakazuje operatorom stawiania dodatkowych warunków, ani na to nie zezwala. Odpowiedzi trzeba szukać w dokumencie operatora regionalnego (pozycja 7 w `./weryfikacja-u-zrodla.md`), a nie w dokumentach PARP; **żaden z sześciu plików w `./zrodla/` tej pozycji nie zamknie**.
