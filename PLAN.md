...
22. Etap 4, pilot: paczka i zlecenie gotowe w `03-pakiet-claude-design/zlecenia/pilot-papier-firmowy.md` (2026-09-02). **Zaktualizowane 2026-09-03**: sąd rejestrowy i kapitał zakładowy odczytane z rejestru KRS i wpisane do zlecenia oraz do warstwy 1, więc z pięciu pól zostały trzy - e-mail, telefon i adres strony. **[FOUNDER]** przeprowadza przez Claude Design; potem Claude Code wpisuje wyniki protokołu pomiaru (polskie znaki na wagach 400-600, siatka 25 mm z treścią, H3 obok leadu, sygnet na rewersie, dokument bez koloru dziedzinowego) → `01-baza-wiedzy/identyfikacja/`. Kontrast Karminu obok Aksamitu ten pilot nie sprawdzi; czeka na pierwszy dokument ze statusami.
