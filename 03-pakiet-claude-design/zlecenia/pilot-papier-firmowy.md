...
| 4 | Sygnet samodzielny na rewersie wizytówki | Zmierzona szerokość sygnetu w mm i ocena czytelności. **Zapis „sygnet stoi na rewersie dokładnie w 10 mm" jest przedawniony i został wycofany 2026-09-03:** właściciel polecił powiększyć sygnet na rewersie i kanwa ma dziś 22 mm. Pomiar 4 nie ma na tej kanwie nośnika - 22 mm stoi powyżej zatwierdzonego minimum 18 mm, więc o spornym wierszu „10 mm / 44 px” nie mówi nic. Trzy wyjścia i decyzja właściciela: `/_robocze/pilot-papier-firmowy/protokol-pomiaru.md`, sekcja „Pomiar 4 stracił nośnik”. | `/01-baza-wiedzy/identyfikacja/logotyp.md`, tabela minimalnych rozmiarów. |
