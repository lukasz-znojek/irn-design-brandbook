...
| 1 - identyfikacja | Paleta **„Regalia”** (7 nośnych + 7 funkcjonalnych + 4 tinty, zatwierdzona 2026-09-03, zastąpiła „Kaszmir Wyciszony”), siatka A4, typografia z H3, logotyp w **wydaniu 02** z ośmioma wersjami kolorystycznymi i dziesięcioma zakazami. Tokeny maszynowe w jednym JSON, przeliczone 2026-09-04. | `01-baza-wiedzy/identyfikacja/`, decyzje w `PLAN.md`, sekcja „Decyzje foundera - rozstrzygnięte”. |
...
| 3 - pakiet | Format paczki z ośmioma zasadami użycia, prompt bazowy odsyłający do warstw 1 i 2, historia decyzji o palecie i siatce. | `03-pakiet-claude-design/`. |
...
| 4 - pilot | Founder w Claude Design, Claude Code buduje paczkę i spisuje wnioski | Paczka gotowa (`03-pakiet-claude-design/zlecenia/pilot-papier-firmowy.md`), adresy kanwy sprawdzone w przeglądarce 2026-09-03: publikacja z 2026-09-03 (`191cf137-…`) zwraca „Page not found" na profilu Personal, a kanwa z 2026-09-02 (`3c6ee053-…`) działa, ale pokazuje wersję sprzed trzech poprawek (sygnet 12 mm zamiast 10 mm, brak kapitału zakładowego i telefonu). **Pomiarów nie robi się na żadnej z nich - kanwę zasiewa się od nowa z paczki.** Zasiana od nowa 2026-09-08 z aktualnych plików: `https://claude.ai/code/artifact/aa2c4c70-bb31-44f0-a0dc-ebe51e6b90c3` (sprawdzić naocznie przed pomiarami). Szczegóły: `/_robocze/pilot-papier-firmowy/README.md`. Pliki źródłowe w `/_robocze/pilot-papier-firmowy/`. **Zlecenie kompletne 2026-09-03** - sąd rejestrowy i kapitał zakładowy z rejestru KRS, e-mail, adres strony i telefon od foundera. Etap czeka wyłącznie na przeprowadzenie pilota przez foundera w Claude Design i na wpisanie sześciu pomiarów do warstwy 1. Bramka: **sześć** pomiarów z protokołu (polskie znaki na wagach 400-600, siatka 25 mm z treścią, H3 obok leadu, sygnet na rewersie, dokument bez koloru dziedzinowego, linie włosowe Popiołu i Złota foliowego na Muślinie) ma wpisany wynik w plikach warstwy 1. Szósty doszedł 2026-09-03, gdy paleta dostała kontrasty na trzech tłach: na Muślinie zapas nad progiem 3:1 wynosi 0,09 dla Popiołu i 0,01 dla Złota foliowego, więc o widoczności decyduje grubość linii i druk. Formularz: `/_robocze/pilot-papier-firmowy/protokol-pomiaru.md`. **Korekta wobec pierwszej wersji tej mapy:** kontrastu Karminu obok Aksamitu ten pilot nie sprawdzi, bo papier firmowy nie ma stanu błędu; ten falsyfikator przechodzi na pierwszy dokument ze statusami (certyfikat albo karta usługi BUR) i nie blokuje bramki B. |
